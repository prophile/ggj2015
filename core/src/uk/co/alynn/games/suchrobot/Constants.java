...
public enum Constants {
    SPEED, INITIAL_ROBOTS, MAX_ROBOTS, INITIAL_WATER, INITIAL_METAL, INITIAL_SALVAGE, TARGET_SALVAGE, DAY_LENGTH, WELL_PUMP_TIME, RESULTS_FADE_TIME, RESULTS_HOLD_TIME, RESULTS_END_TIME, ROBOT_METAL_COST, METAL_MINE_TIME, SALVAGE_TIME, SAFE_ZONE_RADIUS, LAST_DAY;
